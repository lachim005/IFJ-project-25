...
\} \end{alltt}
        ...
        \subsection{Generování výrazů}
            ...
            \subsubsection{Optimalizace}
                ...
                Například u \texttt{a = "ahoj" + unknown} není potřeba generovat typovou kontrolu prvního podvýrazu
                a zároveň nemusíme brát v potaz situaci, kdy \texttt{unknown} bude \texttt{Num}, protože spojovat
                můžeme pouze dva řetězce.
